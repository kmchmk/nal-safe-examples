...
import { AddOwnerTxParams } from '@safe-global/protocol-kit'
...
async function createPropose(){
    ...
    const params: AddOwnerTxParams = {
        ...
        threshold:3 // Optional. If `threshold` isn't provided the current threshold won't change.
      }
      const safeTransaction = await protocolKitOwner1.createAddOwnerTx(params)
